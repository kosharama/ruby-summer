require "./task2/personRepository"
...
class PersonRepositoryTest < Test::Unit::TestCase
  def setup
    ...
    @person1 = Person.new('John', 'Doe', 'AA1234567890', '1990-01-01')
    @person2 = Person.new('Jane', 'Smith', 'AA0987654321', '1985-05-05')
    @repository.add_person(@person1)
  end

  def test_add_person
    person3 = Person.new('Alex', 'Johnson', 'AA1357924680', '1995-07-10')
  ...
  def test_edit_person_by_inn
    ...
    edited_inn = "AA1234567890"
    new_person = Person.new(new_first_name, new_last_name, edited_inn, new_birth_date)
    @repository.edit_person_by_inn("AA1234567890", new_person)
    updated_person = @repository.get_by_inn("AA1234567890")
  ...
  def test_delete_person_by_inn
    assert_raise { @repository.delete_person_by_inn('AA1234567890') }
  end
  ...
  def test_get_by_inn
    assert_equal(@person1, @repository.get_by_inn('AA1234567890'))
  end
